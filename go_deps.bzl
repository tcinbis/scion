...
def go_deps():
    ...
    go_repository(
        name = "com_github_britram_borat",
        importpath = "github.com/britram/borat",
        sum = "h1:eOJHzrH26TPsYqtMlhcRV5NZKwI7iopaFbYwhd03CjA=",
        version = "v0.0.0-20181011130314-f891bcfcfb9b",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:uuhCcu885TE9u/piPYMChI/yqA1lXfaLUEx8uCMxf8w=",
        version = "v0.21.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:XEZ1xGorVy9u+lJq+WXNE+hiqRYLNvJGYmwfwKQN2gU=",
        version = "v0.1.3",
    )
    go_repository(
        name = "com_github_marten_seemann_qtls_go1_17",
        importpath = "github.com/marten-seemann/qtls-go1-17",
        sum = "h1:SficYjyOthSrliKI+EaFuXS6HqSsX3dkY9AqxAAjBjw=",
        version = "v0.1.0-beta.1.2",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_netsec_ethz_rains",
        importpath = "github.com/netsec-ethz/rains",
        sum = "h1:i+z8ws/d56U0XoqVjom4OFfXkUYK1utXrKPPiGDbdME=",
        version = "v0.2.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:IHGo93KUJjih0Gz449MCBDKuaWPqcKcbuUM7GXWFnlw=",
        version = "v1.2.0",
    )
    go_repository(
