...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:Xx8/OynzWhQeKFWr182hg6Ja2evS1gcqdja7qMn05yU=",
        version = "v1.5.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:nKSq662fS0kZ11+Wu3FLg3GQGL0UuH1VxF8wV1QuDEU=",
        version = "v0.49.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        remote = "https://github.com/tcinbis/quic-go",
        vcs = "git",
        commit = "25f9112ce07b2a7a9d6ce2455b8103dbde80b065",
    )
    go_repository(
