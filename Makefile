...
flowtele:
	 bazel build go/flowtele:\* go/flowtele/listener:\* go/flowtele/dbus:\* go/flowtele/stream:\*

flowtele-debug:
	 bazel build go/flowtele:\* go/flowtele/listener:\* go/flowtele/dbus:\* go/flowtele/stream:\* --sandbox_debug
